    ...
    public void Attack()
    {
        ...
        switch (level)
        {
            case 1:
                ...
                rbLv1.AddForce(spawn.transform.up * 10.0f, ForceMode2D.Impulse);
            ...
            case 2:
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    rbLv3_1.AddForce(spawn.transform.up * (10.0f - i), ForceMode2D.Impulse);
                }
            ...
            case 4:
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    rbLv4_1.AddForce(spawn.transform.up * (10.0f - i), ForceMode2D.Impulse);
                }
            ...
            case 5:
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    rbLv5_1.AddForce(spawn.transform.up * (10.0f - i), ForceMode2D.Impulse);
                }
