    ...
    public void Attack()
    {
        ...
        switch (level)
        {
            ...
            default:
                ...
                {
                    GameObject bulletLv3_1 = Instantiate(projectile, spawn.position, spawn.rotation);
                    bulletLv3_1.GetComponent<PoisonProjectile>().killTime = bulletLv3_1.GetComponent<PoisonProjectile>().killTime * 1.1f;
                    bulletLv3_1.GetComponent<PoisonProjectile>().attack = bulletLv3_1.GetComponent<PoisonProjectile>().attack * 1.2f;
                    Rigidbody2D rbLv3_1 = bulletLv3_1.GetComponent<Rigidbody2D>();
                    rbLv3_1.AddForce(spawn.transform.up * (5.0f - i), ForceMode2D.Impulse);
                }
